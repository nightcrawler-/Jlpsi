...
import com.kiki.jlpsi.deviceinfoendpoint.Deviceinfoendpoint;
import com.kiki.jlpsi.deviceinfoendpoint.model.DeviceInfo;
...
import kiki.com.jlpsi.cloud.Remote;
...
public class GCMIntentService extends GCMBaseIntentService {
	 ...
	 * information.
	 */
	protected static final String PROJECT_NUMBER = "820175235736";
	...
	public void onMessage(Context context, Intent intent) {
        try {
            Remote.handleMessage(context, intent.getStringExtra("message"));
	...
	public void onRegistered(Context context, String registration) {
		...
		// persist registration detaisl
		Utils.setGcmRegistered(context, registration);
