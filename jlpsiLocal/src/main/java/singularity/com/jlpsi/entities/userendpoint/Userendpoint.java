 ...
 * on 2015-03-01 at 17:53:57 UTC 
 * Modify at your own risk.
 */

package singularity.com.jlpsi.entities.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<singularity.com.jlpsi.entities.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.String id) {
      super(Userendpoint.this, "GET", REST_PATH, null, singularity.com.jlpsi.entities.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link singularity.com.jlpsi.entities.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(singularity.com.jlpsi.entities.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<singularity.com.jlpsi.entities.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(singularity.com.jlpsi.entities.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, singularity.com.jlpsi.entities.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<singularity.com.jlpsi.entities.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, singularity.com.jlpsi.entities.userendpoint.model.CollectionResponseUser.class);
    }
    ...
    public ListUser setUsername(java.lang.String username) {
    ...
    public ListUser setPassword(java.lang.String password) {
   ...
   * @return the request
   */
  public UpdateUser updateUser(singularity.com.jlpsi.entities.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<singularity.com.jlpsi.entities.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(singularity.com.jlpsi.entities.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, singularity.com.jlpsi.entities.userendpoint.model.User.class);
    }
